...
// @icon         https://cdl.xn--920a.fun/dl/https://aowuucdn.oss-accelerate.aliyuncs.com/codeforces.png
 ...
 */
 ...
 async function initMonacoEditor() {
   if (
     ...
     try {
       ...
       await OJB_LoadJS(
         "https://cdl.xn--920a.fun/dl/https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/monaco-editor/0.49.0/min/vs/loader.min.js",
       ...
       require.config({
         paths: {
           vs: "https://cdl.xn--920a.fun/dl/https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/monaco-editor/0.49.0/min/vs",
         },
 ...
 async function SelectElementPerfOpt() {
   ...
   // 加载库资源
   await OJB_LoadJS(
     "https://cdl.xn--920a.fun/dl/https://aowuucdn.oss-accelerate.aliyuncs.com/js/selectpage.min.js",
 ...
 async function CF2vjudge(problemToolbar) {
   ...
   const vjudgeButton = problemToolbar.addLinkButton(
     "vjudgeButton",
     "https://cdl.xn--920a.fun/dl/https://vjudge.net/",
     i18next.t("state.loading", { ns: "button" }),
     $("<img>").attr(
       "src",
       "https://cdl.xn--920a.fun/dl/https://aowuucdn.oss-accelerate.aliyuncs.com/vjudge.ico"
     )
   );
 ...
 async function validateClistConnection(onlyCookie = false) {
   const clistApiUrl =
     "https://cdl.xn--920a.fun/dl/https://clist.by:443/api/v4/contest/?limit=1&resource_id=1";
 ...
 async function getRatingFromApi_problem(problem_name, problem_url) {
   return OJB_promiseRetryWrapper(
     async () => {
       const response = await OJB_GMRequest({
         method: "GET",
         url: `https://cdl.xn--920a.fun/dl/https://clist.by:443/api/v4/problem/?name=${encodeURIComponent(
           problem_name
 ...
 async function getContestNameFromApi(contestName, contestUrl) {
   return OJB_promiseRetryWrapper(
     async () => {
       const options = {
         method: "GET",
         url: `https://cdl.xn--920a.fun/dl/https://clist.by:443/api/v4/contest/?resource_id=1&event__regex=${encodeURIComponent(
           contestName
         )}`,
         headers: {
 ...
 async function getRatingFromApi_contest(contestName, contestUrl) {
   ...
   return OJB_promiseRetryWrapper(
     async () => {
       const options = {
         method: "GET",
         url: `https://cdl.xn--920a.fun/dl/https://clist.by:443/api/v4/contest/?resource_id=1&with_problems=true&event=${encodeURIComponent(
           actualContestName
         )}`,
         headers: {
           Authorization: OJBetter.clist.authorization,
 ...
 async function showRatingByClist_problem(problemToolbar) {
   ...
   const clistButton = problemToolbar.addLinkButton(
     "clistButton",
     `https://cdl.xn--920a.fun/dl/https://clist.by/problems/?search=${problem}&resource=1&resource=64`,
 ...
 async function showRatingByClist_problemset() {
   ...
   for (let i = 0; i < $trs.length; i++) {
     ...
     problem_url = problem_url.replace(
       /^\/problemset\/problem\/(\d+)\/(\w+)/,
       "https://cdl.xn--920a.fun/dl/https://codeforces.com/contest/$1/problem/$2"
     );
 ...
 async function translate_deepl_api_free(raw) {
   ...
   const options = {
     method: "POST",
     url:
       OJBetter.deepl.config.proxy || "https://cdl.xn--920a.fun/dl/https://api-free.deepl.com/v2/translate",
     headers: {
 ...
 "`
   ...
   const options = {
     ...
     url:
       ...
       "https://cdl.xn--920a.fun/dl/https://api.openai.com/v1/chat/completions",
     data: JSON.stringify(data),
     responseType: "json",
     headers: {
       "Content-Type": "application/json",
